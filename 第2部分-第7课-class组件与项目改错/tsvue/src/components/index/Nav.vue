          ...
          <div class="main-top clearfix">
            ...
            <div class="index-nav-banner-container fl">
              <div class="banners fl">
                <Banner class="banner-1" v-model="curBanner" :data="banners" :autoplay="true" />
                ...
                <Banner class="banner-2" :showNums="false" :data="[]" />
              </div>
              <div class="ads fr">
                <a href="#" class="ad1">
...
import Banner from './NavBanner.vue';
import {Component, Vue} from 'vue-property-decorator';

@Component({
  async created(){
    let {data: {err, msg, data}}=await this.axios('/banner');
