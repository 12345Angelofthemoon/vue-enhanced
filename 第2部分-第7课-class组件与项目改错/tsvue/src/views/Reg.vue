...
import {VueAxios, FormRule} from '@/types/index';

type RegFormData={mobile: string, email: string, password: string, password2: string};
...
export default class Reg extends VueAxios {
  private allOk=false;
