<template lang="html">
  <div class="site-nav">
    <div class="site-nav-page">
      <div class="site-nav-menu fl">
        <a href="javascript:;" class="site-nav-menu-login fl" v-link="{name: 'login'}">亲，请登录</a>
        <a href="#" class="site-nav-menu-reg fl" v-link="{name: 'reg'}">免费注册</a>
      </div>
