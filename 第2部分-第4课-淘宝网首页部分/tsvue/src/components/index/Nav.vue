          ...
          <div class="main-top clearfix">
            ...
            <div class="index-nav-banner-container fl">
              <div class="banners fl">
                <div class="index-header-banner banner-1">
                  <a href="#" class="btn btn-prev">&lt;</a>
                  <a href="#" class="btn btn-next">&gt;</a>
                  <ul style="width:2600px;">
                    <li>
                      <a href="#">
                        <img src="../../assets/imgs/banner-1-1.webp" alt="">
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="../../assets/imgs/banner-1-2.jpg" alt="">
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="../../assets/imgs/banner-1-3.jpg" alt="">
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="../../assets/imgs/banner-1-4.jpg" alt="">
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="../../assets/imgs/banner-1-5.webp" alt="">
                      </a>
                    </li>
                  </ul>
                  <div class="nums">
                ...
                <div class="tmall-title clearfix">
                  <img src="imgs/banner2-title.png" class="fl" alt="">
                ...
                <div class="index-header-banner banner-2">
                  <a href="#" class="btn btn-prev">&lt;</a>
                  <a href="#" class="btn btn-next">&gt;</a>
                  <ul style="width:2600px;">
                    <li>
                      <a href="#">
                        <img src="../../assets/imgs/banner-2-1.png" alt="">
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="../../assets/imgs/banner-2-2.png" alt="">
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="../../assets/imgs/banner-2-3.png" alt="">
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="../../assets/imgs/banner-2-4.png" alt="">
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="../../assets/imgs/banner-2-5.png" alt="">
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <img src="../../assets/imgs/banner-2-6.png" alt="">
                      </a>
                    </li>
                  </ul>
                </div>
